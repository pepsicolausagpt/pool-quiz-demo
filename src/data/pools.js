...
const poolImages = {
  standard: "/images/pools/series-standard.png",
  classic1: "/images/pools/series-classic-1.png",
  classic2: "/images/pools/series-classic-2.png",
  romano: "/images/pools/series-romano.png",
  spaRound: "/images/pools/series-spa-round.png",
  leonardoSpa: "/images/pools/series-leonardo-spa.png",
  leonardo: "/images/pools/series-leonardo.png",
  picasso: "/images/pools/series-picasso.png",
  dali: "/images/pools/series-dali.png",
  gaudi: "/images/pools/series-gaudi.png",
  monet: "/images/pools/series-monet.png",
  giotto: "/images/pools/series-giotto.png",
};

const modelImages = {
  rectangular: "/images/models/model-rect.svg",
  freeform: "/images/models/model-freeform.svg",
  round: "/images/models/model-round.svg",
  standard: "/images/models/model-standard.png",
  classic1: "/images/models/model-classic-1.png",
  classic2: "/images/models/model-classic-2.png",
  romano: "/images/models/model-romano.png",
  spa: "/images/models/model-spa.png",
  modenaFlorence: "/images/models/model-modena-florence.png",
  bergamo: "/images/models/model-bergamo.png",
  leonardoSpa: "/images/models/model-leonardo-spa.png",
  leonardo: "/images/models/model-leonardo.png",
  picasso: "/images/models/model-picasso.png",
  dali: "/images/models/model-dali.png",
  gaudi: "/images/models/model-gaudi.png",
  monet: "/images/models/model-monet.png",
  giotto: "/images/models/model-giotto.png",
};
...
export const poolTypes = [
  ...Object.values(pools).map(({ id, title, description, image }) => ({ id, title, description, image })),
  {
    ...
    image: "/images/pools/pool-custom.svg",
    isCustom: true,
  },
];
